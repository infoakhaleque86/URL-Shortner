    ...
    <div className="container mx-auto p-2">
      <div className="bg-banner my-8 rounded-xl bg-cover bg-center">
        <div className="w-full h-full rounded-xl p-20 backdrop-brightness-50">
          ...
          <p className="text-white text-xl text-center pb-2 font-extralight">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex">
              <div className="relative w-full ">
                ...
                <input
                  type="text"
                  placeholder="add your untidy link here"
                  required
                ...
                <button
                  type="submit"
                  className="absolute top-0 end-0 px-2.5 text-sm font-medium h-full text-white bg-blue-700 rounded-lg border border-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300"
                >
                  Shorten URL
                </button>
              </div>
